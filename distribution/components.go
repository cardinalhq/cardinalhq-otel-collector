...
func components() (otelcol.Factories, error) {
	...
	factories.ExporterModules[chqkubeeventsexporter.NewFactory().Type()] = "github.com/cardinalhq/cardinalhq-otel-collector/exporter/chqkubeeventsexporter v0.119.0"
