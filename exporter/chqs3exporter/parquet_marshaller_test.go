...
func TestParquetMarshalerWithBooleanType(t *testing.T) {
	logs := plog.NewLogs()
...
func TestParquetMarshalerWithNumberType(t *testing.T) {
	logs := plog.NewLogs()
	rls := logs.ResourceLogs().AppendEmpty()
	sl := rls.ScopeLogs().AppendEmpty()
...
func TestParquetMarshalerWithMapType(t *testing.T) {
	logs := plog.NewLogs()
	rls := logs.ResourceLogs().AppendEmpty()
	sl := rls.ScopeLogs().AppendEmpty()
