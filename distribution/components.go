...
func components() (otelcol.Factories, error) {
	...
	factories.ExtensionModules = makeModulesMap(factories.Extensions, map[component.Type]string{
		...
		asapauthextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/asapauthextension v0.160.0",
		awsiamdbauthextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/dbauth/awsiamdbauthextension v0.160.0",
		awsproxy.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/awsproxy v0.160.0",
		azureauthextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/azureauthextension v0.160.0",
		...
		datadogextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/datadogextension v0.160.0",
		awscloudwatchmetricstreamsencodingextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/awscloudwatchmetricstreamsencodingextension v0.160.0",
		awslogsencodingextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/awslogsencodingextension v0.160.0",
		azureencodingextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/azureencodingextension v0.160.0",
		googlecloudlogentryencodingextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/googlecloudlogentryencodingextension v0.160.0",
		jaegerencodingextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/jaegerencodingextension v0.160.0",
		jsonlogencodingextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/jsonlogencodingextension v0.160.0",
		otlpencodingextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/otlpencodingextension v0.160.0",
		skywalkingencodingextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/skywalkingencodingextension v0.160.0",
		textencodingextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/textencodingextension v0.160.0",
		zipkinencodingextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/encoding/zipkinencodingextension v0.160.0",
		...
		dockerobserver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/observer/dockerobserver v0.160.0",
		ecsobserver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/observer/ecsobserver v0.160.0",
		...
		dbstorage.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage/dbstorage v0.160.0",
		redisstorageextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/storage/redisstorageextension v0.160.0",
		pebbletailstorageextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/tailstorage/pebbletailstorageextension v0.160.0",
		sumologicextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/sumologicextension v0.160.0",
		...
		chqauthextension.NewFactory().Type(): "github.com/cardinalhq/cardinalhq-otel-collector/extension/chqauthextension v0.160.0",
		fbnauthextension.NewFactory().Type(): "github.com/cardinalhq/cardinalhq-otel-collector/extension/fbnauthextension v0.160.0",
	})
	...
	factories.ReceiverModules = makeModulesMap(factories.Receivers, map[component.Type]string{
		...
		apachesparkreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/apachesparkreceiver v0.160.0",
		...
		awscontainerinsightreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/awscontainerinsightreceiver v0.160.0",
		...
		awsfirehosereceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/awsfirehosereceiver v0.160.0",
		awslambdareceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/awslambdareceiver v0.160.0",
		awss3receiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/awss3receiver v0.160.0",
		awsxrayreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/awsxrayreceiver v0.160.0",
		azureblobreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/azureblobreceiver v0.160.0",
		azureeventhubreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/azureeventhubreceiver v0.160.0",
		azuremonitorreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/azuremonitorreceiver v0.160.0",
		carbonreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/carbonreceiver v0.160.0",
		chronyreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/chronyreceiver v0.160.0",
		ciscoosreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/ciscoosreceiver v0.160.0",
		...
		cloudfoundryreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/cloudfoundryreceiver v0.160.0",
		collectdreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/collectdreceiver v0.160.0",
		...
		envoyalsreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/envoyalsreceiver v0.160.0",
		expvarreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/expvarreceiver v0.160.0",
		...
		githubreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/githubreceiver v0.160.0",
		gitlabreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/gitlabreceiver v0.160.0",
		...
		googlecloudspannerreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/googlecloudspannerreceiver v0.160.0",
		haproxyreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/haproxyreceiver v0.160.0",
		...
		icmpcheckreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/icmpcheckreceiver v0.160.0",
		...
		kafkametricsreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/kafkametricsreceiver v0.160.0",
		...
		libhoneyreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/libhoneyreceiver v0.160.0",
		lokireceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/lokireceiver v0.160.0",
		macosunifiedloggingreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/macosunifiedloggingreceiver v0.160.0",
		...
		mongodbatlasreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/mongodbatlasreceiver v0.160.0",
		...
		namedpipereceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/namedpipereceiver v0.160.0",
		netflowreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/netflowreceiver v0.160.0",
		nginxreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/nginxreceiver v0.160.0",
		nsxtreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/nsxtreceiver v0.160.0",
		ntpreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/ntpreceiver v0.160.0",
		...
		podmanreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/podmanreceiver v0.160.0",
		...
		pprofreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/pprofreceiver v0.160.0",
		...
		purefareceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/purefareceiver v0.160.0",
		purefbreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/purefbreceiver v0.160.0",
		pulsarreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/pulsarreceiver v0.160.0",
		...
		riakreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/riakreceiver v0.160.0",
		...
		simpleprometheusreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/simpleprometheusreceiver v0.160.0",
		skywalkingreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/skywalkingreceiver v0.160.0",
		snowflakereceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/snowflakereceiver v0.160.0",
		...
		splunkenterprisereceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/splunkenterprisereceiver v0.160.0",
		...
		stefreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/stefreceiver v0.160.0",
		sqlqueryreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/sqlqueryreceiver v0.160.0",
		...
		sshcheckreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/sshcheckreceiver v0.160.0",
		...
		systemdreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/systemdreceiver v0.160.0",
		tcpcheckreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/tcpcheckreceiver v0.160.0",
		...
		tlscheckreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/tlscheckreceiver v0.160.0",
		...
		wavefrontreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/wavefrontreceiver v0.160.0",
		snmpreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/snmpreceiver v0.160.0",
		webhookeventreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/webhookeventreceiver v0.160.0",
		...
		windowsservicereceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/windowsservicereceiver v0.160.0",
		yanggrpcreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/yanggrpcreceiver v0.160.0",
		...
		signalfxreceiver.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/receiver/signalfxreceiver v0.160.0",
	...
	factories.ExporterModules = makeModulesMap(factories.Exporters, map[component.Type]string{
		...
		alibabacloudlogserviceexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/alibabacloudlogserviceexporter v0.160.0",
		awscloudwatchlogsexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awscloudwatchlogsexporter v0.160.0",
		awsemfexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awsemfexporter v0.160.0",
		awskinesisexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awskinesisexporter v0.160.0",
		awsxrayexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awsxrayexporter v0.160.0",
		azureblobexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/azureblobexporter v0.160.0",
		azuredataexplorerexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/azuredataexplorerexporter v0.160.0",
		azuremonitorexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/azuremonitorexporter v0.160.0",
		bmchelixexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/bmchelixexporter v0.160.0",
		cassandraexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/cassandraexporter v0.160.0",
		...
		coralogixexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/coralogixexporter v0.160.0",
		datadogexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/datadogexporter v0.160.0",
		datasetexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/datasetexporter v0.160.0",
		dorisexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/dorisexporter v0.160.0",
		elasticsearchexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/elasticsearchexporter v0.160.0",
		...
		googlecloudstorageexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlecloudstorageexporter v0.160.0",
		...
		honeycombmarkerexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/honeycombmarkerexporter v0.160.0",
		influxdbexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/influxdbexporter v0.160.0",
		...
		logicmonitorexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/logicmonitorexporter v0.160.0",
		logzioexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/logzioexporter v0.160.0",
		mezmoexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/mezmoexporter v0.160.0",
		opensearchexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/opensearchexporter v0.160.0",
		...
		pulsarexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/pulsarexporter v0.160.0",
		rabbitmqexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/rabbitmqexporter v0.160.0",
		sentryexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/sentryexporter v0.160.0",
		signalfxexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/signalfxexporter v0.160.0",
		splunkhecexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/splunkhecexporter v0.160.0",
		stefexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/stefexporter v0.160.0",
		sumologicexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/sumologicexporter v0.160.0",
		...
		tencentcloudlogserviceexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/tencentcloudlogserviceexporter v0.160.0",
		tinybirdexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/tinybirdexporter v0.160.0",
		...
		awss3exporter.NewFactory().Type(): "github.com/cardinalhq/cardinalhq-otel-collector/exporter/awss3exporter v0.160.0",
	})
	...
	factories.Processors, err = otelcol.MakeFactoryMap[processor.Factory](
		...
		spanpruningprocessor.NewFactory(),
	...
	factories.ProcessorModules = makeModulesMap(factories.Processors, map[component.Type]string{
		...
		coralogixprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/coralogixprocessor v0.160.0",
		...
		genainormalizerprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/genainormalizerprocessor v0.160.0",
		...
		isolationforestprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/isolationforestprocessor v0.160.0",
		...
		schemaprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/schemaprocessor v0.160.0",
		spanprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/spanprocessor v0.160.0",
		spanpruningprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/spanpruningprocessor v0.160.0",
		sumologicprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/sumologicprocessor v0.160.0",
		...
		unrollprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/unrollprocessor v0.160.0",
		cardinalityguardianprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/cardinalityguardianprocessor v0.160.0",
		aggregationprocessor.NewFactory().Type(): "github.com/cardinalhq/cardinalhq-otel-collector/processor/aggregationprocessor v0.160.0",
		summarysplitprocessor.NewFactory().Type(): "github.com/cardinalhq/cardinalhq-otel-collector/processor/summarysplitprocessor v0.160.0",
		fbnvalidatorprocessor.NewFactory().Type(): "github.com/cardinalhq/cardinalhq-otel-collector/processor/fbnvalidatorprocessor v0.160.0",
	})
	...
	factories.ConnectorModules = makeModulesMap(factories.Connectors, map[component.Type]string{
		...
		datadogconnector.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/connector/datadogconnector v0.160.0",
		...
		sumconnector.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/connector/sumconnector v0.160.0",
