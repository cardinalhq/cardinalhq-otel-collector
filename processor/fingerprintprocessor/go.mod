module github.com/cardinalhq/cardinalhq-otel-collector/processor/fingerprintprocessor
...
require (
	...
	github.com/cardinalhq/oteltools v0.0.0-20241120181106-8e12f903d910
