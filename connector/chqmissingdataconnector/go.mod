module github.com/cardinalhq/cardinalhq-otel-collector/connector/chqmissingdataconnector
...
require (
	...
	github.com/apache/datasketches-go v0.0.0-20251020143343-b86b07683862 // indirect
